...
python promptIt.py -output_json books_prompted -list_size 50 \
    -first_prompt     "To generate a list of the most prolific characters in fiction I first need the books they are from. List the top {list_size} most prolific books in the entire public domain. Each entry in your response will be directly parsed into a JSON dataset so please ONLY provide the name of the **book** without further elaboration or commentary." \
    -assistant_prompt "1. "
python askIt.py   -input_json books_prompted -model gpt-4 -resume 
...
python promptIt.py -input_json books_split -output_json characters_prompted -list_size 4 \
    ...
    -assistant_prompt "1. "
python askIt_threaded.py   -input_json characters_prompted -model gpt-4 -resume -max_threads 10
...
python askIt_threaded.py   -input_json characters_descriptions_prompted -model gpt-4 -resume -max_threads 10
...
python promptIt.py -output_json scenario_moods_prompted -list_size 20 \
    ...
    -assistant_prompt "1. "
python askIt_threaded.py   -input_json scenario_moods_prompted -model gpt-4 -resume -max_threads 10
...
python askIt_threaded.py    -input_json character_pair_moods_prompted -temperature 1.0 -top_p 0.9 -presence_penalty 0.4 -frequency_penalty 0.4 -model gpt-4 -max_threads 10 -resume
...
python askIt_threaded.py    -input_json character_pair_scenarios_prompted -temperature 1.0 -top_p 0.9 -presence_penalty 0.3 -frequency_penalty 0.2 -max_tokens 3000 -model gpt-4 -max_threads 10 -resume
...
python askIt_threaded.py    -input_json character_pair_scenarios_prompted2  -output_json character_pair_scenarios_asked2    -temperature 1.0 -top_p 0.9 -presence_penalty 1.5 -frequency_penalty 0.3 -max_tokens 3000 -model gpt-4 -max_threads 10 -resume
...
python askIt_threaded.py    -input_json character_pair_scenarios_prompted3  -output_json character_pair_scenarios_asked3    -temperature 1.0 -top_p 0.9 -presence_penalty 1.0 -frequency_penalty 0.2 -max_tokens 4000 -model gpt-4 -max_threads 10 -resume
...
python askIt_threaded.py    -input_json character_pair_scenarios_prompted4  -output_json character_pair_scenarios_asked4    -temperature 1.0 -top_p 0.9 -presence_penalty 1.0 -frequency_penalty 0.2 -max_tokens 4000 -model gpt-4 -max_threads 10 -resume
