...
python promptIt.py -output_json genres_prompted -list_size 10 \
    ...
    -assistant_prompt "1. " 
python askIt.py   -input_json genres_prompted -resume 
...
python askIt.py   -input_json books_prompted -include_chat_history -resume 
...
python promptIt.py -input_json books_split -output_json characters_prompted -list_size 4 \
    ...
    -assistant_prompt "1. "
python askIt.py   -input_json characters_prompted -include_chat_history -resume 
...
python askIt.py   -input_json characters_descriptions_prompted -resume 
...
python promptIt.py -output_json scenario_moods_prompted -list_size 20 \
    ...
    -assistant_prompt "1. "
python askIt.py   -input_json scenario_moods_prompted -resume 
...
python askIt.py    -input_json character_pair_moods_prompted -temperature 1.0 -top_p 0.9 -presence_penalty 0.4 -frequency_penalty 0.4 -resume 
...
python askIt.py    -input_json character_pair_scenarios_prompted -temperature 1.0 -top_p 0.9 -presence_penalty 0.3 -frequency_penalty 0.2 -max_tokens 3000 -resume 
...
python askIt.py    -input_json character_pair_scenarios_prompted2 -output_json character_pair_scenarios_asked2 -temperature 1.0 -top_p 0.9 -presence_penalty 0.3 -frequency_penalty 0.2 -max_tokens 3000 -resume 
...
python askIt.py    -input_json character_pair_scenarios_prompted3 -output_json character_pair_scenarios_asked3 -temperature 1.0 -top_p 0.9 -presence_penalty 0.3 -frequency_penalty 0.2 -max_tokens 3000 -resume 
